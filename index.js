...
console.log("Precio Libro: " + miLibreria.getPrecioLibro(miLibreria.getCliente("Catalina"), teoriaDeJuegos));
console.log("Precio Libro: " + miLibreria.getPrecioLibro(miLibreria.getCliente("German"), teoriaDeJuegos));
console.log("VENTAS");
